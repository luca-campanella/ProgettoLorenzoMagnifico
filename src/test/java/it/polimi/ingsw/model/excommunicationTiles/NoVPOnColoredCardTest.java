...
public class NoVPOnColoredCardTest {
    ...
    public void noVPColoredCard() throws Exception {
        boolean valueTest = excommunicationTiles.get(14).effect.noVPColoredCard(CardColorEnum.GREEN);
        boolean valueSecondTest = excommunicationTiles.get(15).effect.noVPColoredCard(CardColorEnum.BLUE);
        boolean valueThirdTest = excommunicationTiles.get(16).effect.noVPColoredCard(CardColorEnum.PURPLE);
        boolean valueFourthTest = excommunicationTiles.get(16).effect.noVPColoredCard(CardColorEnum.GREEN);
